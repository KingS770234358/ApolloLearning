...
java -Xms256m -Xmx256m -Dapollo_profile=github -Dserver.port=8081 -DSpring"."datasource"."url=jdbc:mysql://${url}/ApolloConfigDBPro?characterEncoding=utf8"&"serverTimezone=UTC -DSpring"."datasource"."username=${username} -Dspring"."datasource"."password=${password} -Dlogging"."file"."name=./logs/apollo-service-pro.log -jar ./configservice/apollo-configservice-1.8.2.jar &
echo "============================================================================"
java -Xms256m -Xmx256m -Dapollo_profile=github -Dserver.port=8091 -Dspring"."datasource"."url=jdbc:mysql://${url}/ApolloConfigDBPro?characterEncoding=utf8"&"serverTimezone=UTC -Dspring"."datasource"."username=${username} -Dspring"."datasource"."password=${password} -Dlogging"."file"."name=./logs/apollo-adminservice-pro.log -jar ./adminservice/apollo-adminservice-1.8.2.jar & 
sleep 100000